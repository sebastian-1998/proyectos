...
<div class="form-group">
    ...
    <textarea class="form-control" rows="20" id="contenido" name="texto" placeholder="CONTENIDO ENTRADA"><?php echo $validador -> obtener_texto(); ?></textarea>
...
<div class="checkbox">
    <h4><label style="color: black">
            <input type="checkbox" value="SI" name="publicar" <?php if($validador -> obtener_checkbox()) echo 'checked' ?>> Esta opcion permite que la entrada sea publicada de inmediato
